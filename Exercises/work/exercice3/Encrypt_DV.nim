...
# Clé définie pour XOR operations
# avec la même clé que celle utilisée pour encrypter le code
const key: uint8 = 0x52

# fonction pour encrypter le shellcode
...
# fonction pour imprimer le tableau de bytes encryptés
...
when isMainModule:
    # unencrypted shellcode pour le programme charmap.exe
    let sc: array[299, byte] = [
        ...
        0x63,0x68,0x61,0x72,0x6d,0x61,0x70,0x2e,0x65,0x78,0x65,0x00
        ]
           

    # Encodage du shellcode à l'aide de la clé 0x52 et ensuite on copie/collé dans le progamme 'BasicAVEvasion.nim' avant de le compiler
