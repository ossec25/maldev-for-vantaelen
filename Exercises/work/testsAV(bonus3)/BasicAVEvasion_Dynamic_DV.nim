...
proc injectShellcode[I, T](shellcode: array[I, T]): void =
    ...
    if (commandLineParams().len != 1):
        echo "Incorrect number of arguments.\nUsage: BasicAVEvasion_Dynamic_DV.exe <target process> with .exe suffix"
        quit(1)
    ...
    # ici il est renvoyé par la fonction getProcessByName qui reçoit le nom de l'exécutable passé en ligne de commande
